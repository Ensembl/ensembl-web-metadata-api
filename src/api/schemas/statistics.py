    ...
    def __init__(self, **data):
        ...
        try:
            for stats_item in data["_raw_data"]:
                try:
                    data["_compiled_data"][stats_item["name"]] = stats_item.get(
...
class ExampleObjectList(BaseModel):
    ...
    def extract_example_objects(genome_uuid, attributes_info):
        ...
        try:
            if attributes_info["genebuild_sample_gene"]:
            ...
            if attributes_info["genebuild_sample_location"]:
            ...
            if attributes_info["variation_sample_variant"]:
